...
public class SentBroadcastsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<BroadCast> items = new ArrayList<>();

    private Context context;
    private SentBroadcastsAdapter.OnItemClickListener onItemClickListener;

    public interface OnItemClickListener{
        void onItemClick(int position);
    }
    public void setOnItemClickListener(SentBroadcastsAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    public SentBroadcastsAdapter(Context context, List<BroadCast> items) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_approved_broadcast, parent, false);
