...
import mhealth.login.adapters.PendingBroadcastsAdapter;
...
public class ApprovalFragment extends Fragment {
    ...
    private PendingBroadcastsAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root =  inflater.inflate(R.layout.fragment_approval, container, false);
        unbinder = ButterKnife.bind(this, root);

        loggedInUser = (User) Stash.getObject(Constants.LOGGED_IN_USER, User.class);

        if (loggedInUser.getProfile_complete() == 0){
            NavHostFragment.findNavController(ApprovalFragment.this).navigate(R.id.nav_complete_profile);
        }


        broadCastArrayList = new ArrayList<>();
        mAdapter = new PendingBroadcastsAdapter(context, broadCastArrayList);
        ...
        mAdapter.setOnItemClickListener(new PendingBroadcastsAdapter.OnItemClickListener() {
            @Override
