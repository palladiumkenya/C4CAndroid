...
public class MultiSelectSpinnerPpe extends AppCompatSpinner implements DialogInterface.OnMultiChoiceClickListener {
    ...
    public MultiSelectSpinnerPpe(Context context) {
        super(context);
        c = context;
    ...
    public MultiSelectSpinnerPpe(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean performClick() {
        ...
        builder.setTitle("Please select PPE's worn.");
